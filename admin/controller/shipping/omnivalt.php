...
class ControllerShippingOmnivalt extends Controller
{
  ...
  ADD `cod_amount` FLOAT DEFAULT 0;";
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->link('shipping/omnivalt', 'token=' . $this->session->data['token'], true);
  ...
  <reference_number>' . self::getReferenceNumber($order['order_id']) . '2</reference_number>';
        } else {
            return '';
        }
    }
